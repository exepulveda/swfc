...
if __name__ == "__main__":
    ...
    #Generate centroids
    centroids = crisp_centroids(data_scaled,kmeans_clusters,NC)
    #print('centroids',centroids)

    #Generate U matrix for kmeas
    u = crisp_to_fuzzy(data_scaled,centroids,p=2.0)
    #print('u',u)
    ...
    #for i in range(N):
    #    print(i,kmeans_clusters[i],u[i],clusters_graph[i],sep=',')

    np.savetxt("../results/final_ds4_clusters_skmeans_4.csv",clusters_graph,delimiter=",",fmt="%.4f")
