...
if __name__ == "__main__":
    ...
    for k in range(100):
        ...
        np.savetxt(template.format(tag="u"),best_u,delimiter=",",fmt="%.4f")
        np.savetxt(template.format(tag="centroids"),best_centroids,delimiter=",",fmt="%.4f")
        np.savetxt(template.format(tag="clusters"),clusters,delimiter=",",fmt="%.4f")
        np.savetxt(template.format(tag="weights"),best_weights,delimiter=",",fmt="%.4f")
