...
fignames = ['fig8a','fig8b','fcew','sfcew','fig8c','fig8d']
...
facecolor = {0: 'r', 1: 'c', 2: 'b', 3: 'g', 4: 'k', 5: 'w'}
...
for c,cluster in enumerate([kmeans,pca,fcew,sfcew,fc,sfc]):
    ...
    new_clusters = relabel(cluster_target,cluster,NC)
    ...
    plt.savefig("../figures/projections/%s.pdf"%fignames[c],bbox_inches='tight')
    plt.close('all')
